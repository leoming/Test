/****************************************************************************
** Meta object code from reading C++ file 'chessspace.h'
**
...
#error "The header file 'chessspace.h' doesn't include <QObject>."
...
const QMetaObject Space::staticMetaObject = {
    { &SYBEROS::CWorkspace::staticMetaObject, qt_meta_stringdata_Space.data,
      qt_meta_data_Space,  qt_static_metacall, 0, 0}
};
...
void *Space::qt_metacast(const char *_clname)
{
    ...
    return SYBEROS::CWorkspace::qt_metacast(_clname);
}

int Space::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SYBEROS::CWorkspace::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
